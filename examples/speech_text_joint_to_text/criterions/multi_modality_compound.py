...
from .multi_modality_cross_entropy_mine import SpeechTextPreTrainCrossEntCriterionMine
...
@register_criterion(
    "speech_text_pretrain_compound_mine", dataclass=SpeechTextPreTrainCompoundCriterionConfig
)
class SpeechTextPreTrainCompoundCriterionMine(FairseqCriterion):
    def __init__(
        self,
        task,
        sentence_avg,
        ...
        super().__init__(task)
        self.xent = SpeechTextPreTrainCrossEntCriterionMine(
