...
from fairseq.data.audio.multi_modality_dataset_mine import FileAudioDatasetWrapperMine
...
@register_task("speech_text_joint_denoising_mine")
    ...
    def load_dataset(self, split, epoch=1, combine=False, **kwargs):
        ...
        if is_train:
            ...
            if self.args.unsup_speech_train_data != "":
                unsup_speech_dataset = FileAudioDatasetWrapperMine(
