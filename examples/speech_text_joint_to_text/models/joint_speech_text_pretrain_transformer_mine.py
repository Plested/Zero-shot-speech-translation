    ...
    def get_targets(self, sample, net_output):
        ...
        if mode == "unsup_speech":
            return {"target_logprobs": net_output[1]["pseudo_target_logprobs"],
                    "target_logprobs1": net_output[3]["pseudo_target_logprobs1"]}
...
@register_model_architecture(
    "speech_text_pretrain_bart_mine", "speech_text_pretrain_bart_base_mine"
)
...
@register_model_architecture(
    "speech_text_pretrain_bart_mine", "speech_text_pretrain_bart_base_stack_mine"
)
...
@register_model_architecture(
    "speech_text_pretrain_bart_mine", "speech_text_pretrain_bart_large_mine"
)
...
@register_model_architecture(
    "speech_text_pretrain_bart_mine", "speech_text_pretrain_bart_large_stack_mine"
)
